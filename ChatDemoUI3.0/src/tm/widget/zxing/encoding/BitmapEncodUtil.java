...
public class BitmapEncodUtil {
	 ...
	 * @return
	 */
	public static File createQRCode(String str, int widthAndHeight)
		...
		try {
			file = ImageUtil.saveStickerBitmap(bitmap, Constant.QRCODE_FILE_PATH);
		} catch (IOException e) {
			e.printStackTrace();
		}finally {

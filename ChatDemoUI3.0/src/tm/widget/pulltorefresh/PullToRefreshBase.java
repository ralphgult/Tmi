...
import tm.widget.pulltorefresh.internal.RotateLoadingLayout;
import tm.widget.pulltorefresh.internal.Utils;
import tm.widget.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private String mHeaderReleaseTime;
    SharedPreferences sharePre;
    String lastUpdatePreString;
    private boolean webViewSubText;
    // ===========================================================
    // Constructors
    // ===========================================================
...
//                }
    ...
    public final void onRefreshComplete() {
        ...
        getReFreshTime();
        sharePre.edit().putString(REFRESH_TIME, mHeaderReleaseTime).commit();
        setLastUpdatedLabel(lastUpdatePreString + mHeaderReleaseTime);//显示时间
    }
    ...
    public void setLastUpdatedLabel(CharSequence label) {
        ...
        webViewSubText = false;
    }

    /**
     * 为了在新闻详情加载时去掉刷新时间
     * @param webViewSubText
     */
    public void setWebViewSubText(boolean webViewSubText){
           this.webViewSubText = webViewSubText;
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        sharePre = context.getSharedPreferences("refresh_time", Context.MODE_PRIVATE);
        mHeaderReleaseTime = sharePre.getString(REFRESH_TIME, null);

        if (mHeaderReleaseTime == null) {
            getReFreshTime();
        }
...
//        lastUpdatePreString = ResUtil.getString(context, "latest_refresh_time");
        lastUpdatePreString="上次更新时间";
        setLastUpdatedLabel(lastUpdatePreString + mHeaderReleaseTime);
    ...
    private void pullEvent() {
        ...
        if (newScrollValue != 0 && !isRefreshing()) {
            ...
            if (mState != State.PULL_TO_REFRESH && itemDimension >= Math.abs(newScrollValue)) {
                ...
                /*
                zhaoyp 修复问题: 当手指滑动特别快时，首次捕获到move事件时，newScrollValue 已经大于 itemDimension
                ,但是当前状态还不是PULL_TO_REFRESH,也无法修改状态为 RELEASE_TO_REFRESH。
                 */

...
//        public static String ROOT_HOST_NAME="http://192.168.1.110:8080";
    ...
    public static String RUL_ADD_FRIEND = ROOT_HOST_NAME + "/CBDParkingMSs/friends/reqFriends";//添加好友2
...
//    public static String URL_INFO = ROOT_HOST_NAME + "/CBDParkingMSs/infoByUserName";//获取用户信息
    ...
    public static String URL_CREATE_ORSER = ROOT_HOST_NAME + "/CBDParkingMSs/order/addPay";//创建订单
